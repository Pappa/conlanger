...
- `docs/SYSTEM.md` and stage docs list three rows. Inventory, correction-loop command (`uv run create_index`), and failure-class CSVs are documented under validate.
