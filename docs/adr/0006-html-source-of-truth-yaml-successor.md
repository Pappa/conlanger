...
- **Declare cleaned YAML SoT immediately** — desirable end state, but the cleaned corpus does not exist yet as an authoritative artifact.
...
- Until that corpus exists and is adopted, regenerations should be traceable back to the HTML.
