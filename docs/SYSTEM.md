...
| **Rule index (Index Diachronica)** | [IndexDiachronicaParser](../src/conlanger/tools/parsers.py), [asca_validator](../src/conlanger/tools/asca_validator.py), [DiachronicSeries](../src/conlanger/tools/rules.py); work under `.scratch/rule-index/` | Applier-neutral **rule index** YAML compiled to ASCA (Brassica later); see [Pipeline stages (new)](#pipeline-stages-new), [ADRs 0001–0006](./adr/), [0010](./adr/0010-historical-fidelity-class-first-status.md) |
