...
Findings markdown under `.scratch/rule-index/research/` (e.g. `field-isolation-compile-validation.md`) with a clear **go / no-go / go-with-limits** recommendation and open questions for a follow-on task ticket.
