...
- Evidence: `.scratch/rule-index/research/_spike09/sound_change_abbreviations.txt`, `index_diachronica_original.html`, [01-valid-asca-rule-string](01-valid-asca-rule-string.md).

## Answer

Domain terms: **Class letter**, **Symbol**, **Meta-notation**, **DiachronicSeries**, **Abbreviation table**, **Failure class**, **Subscript notation**, **Correspondence series**, **Section-local abbreviation** — see `CONTEXT.md`.
...
- **Class letters** at compile/runtime: **DiachronicSeries** loads `data/asca/group_mappings.csv`, passes mappings to the transformer; unmapped tokens stay as-is. Retire ingest `str.maketrans`.
...
- **Brassica:** deferred .
- **Follow-on:** [Spike 09](09-spike-asca-class-letter-feature-matrices.md) (done); implement **DiachronicSeries**.
