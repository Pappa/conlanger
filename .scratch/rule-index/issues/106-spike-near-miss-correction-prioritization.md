...
3. Bucket by shape / error message / field blame — reuse and extend [`scan_syntax_other_near_miss.py`](../research/scan_syntax_other_near_miss.py) pattern; pull from [`expected_underscore_errors.csv`](../inventory/expected_underscore_errors.csv), [`nested_brackets_errors.csv`](../inventory/nested_brackets_errors.csv), [`unknown_character_errors.csv`](../inventory/unknown_character_errors.csv), [`field-isolation-error.csv`](../inventory/field-isolation-error.csv) where useful.
