...
5. **Section-complete impact** — re-count from current `rule-inventory-error.csv`; rank subclusters.

**Deliverables:**
- Findings: `.scratch/rule-index/research/breve-vowel-notation.md`
- Optional CSV: `.scratch/rule-index/research/breve-vowel-notation.csv` (columns like [unknown-character-ipa-mappings.csv](../research/unknown-character-ipa-mappings.csv): `source`, `subcluster`, `raw_snippet`, `linguistic_gloss`, `candidate_target`, `asca_probe_result`, `confidence`, `recommendation`)
