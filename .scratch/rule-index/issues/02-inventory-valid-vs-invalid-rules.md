...
**Artifacts:**
- [../inventory/rule-inventory.csv](../inventory/rule-inventory.csv) — one row per rule (`section_index`, `section_name`, `rule_idx`, `syntax`, `ok`, `returncode`, `error`, `error_class`)
- [../inventory/rule-inventory-summary.md](../inventory/rule-inventory-summary.md)
