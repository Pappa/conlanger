...
Target cluster: `syntax_other` — **`∅` in parallel output sets** — **24** rules in ≤3-fail sections (**17** mono-class sections would complete if cleared). Full-index count TBD at claim time ([inventory summary](../inventory/rule-inventory-summary.md)).
