...
Re-baseline against cleaned schema + ASCA 0.10.2, replacing the provisional 0.9.3 / `index_diachronica_ai.yml` inventory in `diagnostics/inventory/`.
...
- [x] Inventory artifacts written under `diagnostics/inventory/`
...
Artifacts: `diagnostics/inventory/rule-inventory.csv` and `rule-inventory-summary.md`.
