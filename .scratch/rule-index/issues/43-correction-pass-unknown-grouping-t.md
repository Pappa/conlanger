...
Target cluster: `unknown_grouping` where `error_token` is **`T`** — **49** rules at current inventory baseline ([summary](../inventory/rule-inventory-summary.md)); **49 / 133** (37%) of remaining `unknown_grouping` failures.
