...
Target cluster: `unknown_character` — error tokens **`₀`** (49 rules), **`₁`** (37 rules) — **86** failing index rules in [rule-inventory-error.csv](../inventory/rule-inventory-error.csv) (2026-08-07 baseline: **6395 / 9201 ok**).
