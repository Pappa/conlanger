...
**Source:** `.scratch/rule-index/inventory/rule-inventory-error.csv` (ASCA 0.10.2 baseline: **613** `unknown_character` rows).
...
- Index inventory: [rule-inventory-summary.md](../inventory/rule-inventory-summary.md)
