...
Baseline: **251** rules, **39** distinct `unknown_feature` tokens ([inventory summary](../inventory/rule-inventory-summary.md)); Levenshtein triage in [unknown-feature-suggestions-assessment.md](./unknown-feature-suggestions-assessment.md) (not authoritative).
...
| Failure counts | [rule-inventory-summary.md](../inventory/rule-inventory-summary.md) |
