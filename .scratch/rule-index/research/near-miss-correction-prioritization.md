...
- Inventory regen: `uv run create_index && uv run validate_rules` → [`rule-inventory-summary.md`](../inventory/rule-inventory-summary.md), [`rule-inventory-success.csv`](../inventory/rule-inventory-success.csv), [`rule-inventory-error.csv`](../inventory/rule-inventory-error.csv)
- Scan: [`scan_near_miss_all_classes.py`](./scan_near_miss_all_classes.py) → [`near-miss-all-classes.csv`](./near-miss-all-classes.csv)
- Auxiliary CSVs: [`expected_underscore_errors.csv`](../inventory/expected_underscore_errors.csv), [`nested_brackets_errors.csv`](../inventory/nested_brackets_errors.csv), [`unknown_character_errors.csv`](../inventory/unknown_character_errors.csv), [`unknown_features_errors.csv`](../inventory/unknown_features_errors.csv), [`field-isolation-error.csv`](../inventory/field-isolation-error.csv)
