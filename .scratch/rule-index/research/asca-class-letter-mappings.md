...
| **K** | Velar | `[+cons,-fr,+bk,+hi,-lo]` | `C:[-front,+back,+hi,-lo]` | high | Crate TODO for **K** velar ([`parser.rs` L780](https://github.com/Girv98/asca-rust/blob/0.10.2/src/rule/parser.rs)); **C:** host matches `DiachronicSeries.aliases` intent |
...
- **Current K:** Same matrix as [`DiachronicSeries.aliases`](../../../src/conlanger/tools/DiachronicSeries.py) but without **C:** host — can match high back vowels.
...
From [`.scratch/rule-index/inventory/rule-inventory.csv`](../inventory/rule-inventory.csv) (16 `unknown_grouping` rows):
...
|-------|----------------|
| Index class letter definitions | [`.scratch/rule-index/research/_spike09/sound_change_abbreviations.txt`](_spike09/sound_change_abbreviations.txt); [HTML §5 Key to Abbreviations](../../../src/conlanger/data/diachronica/index_diachronica_original.html#Abbreviations) |
