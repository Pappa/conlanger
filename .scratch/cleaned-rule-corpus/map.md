...
- **Correction priority (2026-08-12):** [62 tone](issues/62-correction-pass-tone-features.md) → [63 near-miss unknown_character](issues/63-correction-pass-near-miss-unknown-character.md) → re-review → [64 syntax_other spike](issues/64-spike-syntax-other-near-miss-sections.md) (backlog). Parallel when free: ~~[65 series coverage](issues/65-series-mappings-coverage-pass.md)~~ done — **policy revisit:** [Grill: correspondence-series mapping source of truth](issues/72-grill-series-mapping-manual-sot.md). Optional outputs: [66](issues/66-implement-optional-outputs-alt-idx.md) resolved; [67 nested sets spike](issues/67-spike-nested-sets.md) resolved → [69](issues/69-correction-pass-flatten-nested-context-sets.md) / [70](issues/70-correction-pass-flatten-nested-io-sets.md) / [71 grill](issues/71-grill-paren-and-parallel-set-notation.md); [68 sporadic](issues/68-sporadic-sampling.md) `needs-triage`.
...
- **Subscript notation (all four uses)** — grilled + researched: [subscript-notation-index-asca-brassica.md](research/subscript-notation-index-asca-brassica.md), [positional-slots-and-identity-subscripts.md](research/positional-slots-and-identity-subscripts.md). **Working policy:** correspondence-series + collective → **parse-time**; positional + identity → **compile-time** (Index-shaped in YAML). **Phase 1:** [Correction pass: positional slots and identity subscripts](issues/40-correction-pass-positional-identity-subscripts.md) (+51 ok). **Phase 2:** ~~[Correction pass: subscript edge cases](issues/41-correction-pass-subscript-edge-cases.md)~~ done (+14 ok; matrix/ˤ/compounds/optional shipped; prose + `Bʱ₁` hold-outs). **Compile order:** [research/asca-compile-transform-order.md](research/asca-compile-transform-order.md). **Open:** [Grill: correspondence-series mapping source of truth](issues/72-grill-series-mapping-manual-sot.md) — rule I/O inference may conflate sound changes with abbreviation definitions; owner wants manual SoT + compile-time skip/config for unresolvable tokens.
