...
- [Feature bundle expansion + vowel-height compounds](issues/57-feature-bundle-expansion-vowel-height.md) — grilled 2026-08-08: `mapping_kind=bundle` plumbing; seed `close-mid`→`-hi,-lo,+tense`, `open-mid`→`-hi,-lo,-tense` per [ASCA vowel-space](https://github.com/Girv98/asca-rust/blob/36c3c623fb9f501a358ae087764e77b92d0037bf/doc/doc.md#segment-features); unblocks [#54 place bundles](issues/54-correction-pass-unknown-feature-place-bundles.md).
