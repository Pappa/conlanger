...
- [Grill: optional outputs](issues/61-grill-optional-outputs.md) — **resolved** (2026-08-12): unpaired output sets → `alternatives` + uniform instance-`Random` pick; inventory `alt_idx`. Follow-ups: [66 implement](issues/66-implement-optional-outputs-alt-idx.md), [67 nested sets spike](issues/67-spike-nested-sets.md), [68 sporadic sampling](issues/68-sporadic-sampling.md).
