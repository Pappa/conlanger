...
- **Correction priority (2026-08-12):** [62 tone](issues/62-correction-pass-tone-features.md) → [63 near-miss unknown_character](issues/63-correction-pass-near-miss-unknown-character.md) → re-review → [64 syntax_other spike](issues/64-spike-syntax-other-near-miss-sections.md) (backlog). Parallel when free: [65 series coverage](issues/65-series-mappings-coverage-pass.md). Optional outputs: [66](issues/66-implement-optional-outputs-alt-idx.md) resolved; [67 nested sets spike](issues/67-spike-nested-sets.md) resolved → [69](issues/69-correction-pass-flatten-nested-context-sets.md) / [70](issues/70-correction-pass-flatten-nested-io-sets.md) / [71 grill](issues/71-grill-paren-and-parallel-set-notation.md); [68 sporadic](issues/68-sporadic-sampling.md) `needs-triage`.
