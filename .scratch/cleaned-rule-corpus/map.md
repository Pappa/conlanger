...
- [Grill: optional outputs](issues/61-grill-optional-outputs.md) — **ready-for-human** (grill closed 2026-08-12): resolve unpaired output sets via `alternatives` + `alt_idx`; sporadic/nested follow-ups. Awaiting owner confirm before filing implementation.
