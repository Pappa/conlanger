...
- [Correction pass: unknown_grouping residual `T`](issues/43-correction-pass-unknown-grouping-t.md) — `_GROUPING_FOLLOW` misses IPA tails (`Tʃ`); 49 rules; Phase 1 fix ready-for-agent.
