...
**C, O, F, L, N, V** — Index definitions match ASCA groupings ([Key to Abbreviations](../../../notebooks/data/sound_change_abbreviations.txt), [doc.md Groupings](https://github.com/Girv98/asca-rust/blob/0.10.2/doc/doc.md#groupings)). Do **not** add rows: extra mappings would break rules that rely on ASCA-native semantics (especially **C** post-0.10.0).
...
- **Index:** `A = Affricate` ([sound_change_abbreviations.txt L13](../../../notebooks/data/sound_change_abbreviations.txt)).
...
| **X** | Meta-variable “any segment” ([Key `(…X)`](../../../notebooks/data/sound_change_abbreviations.txt)) | Not a class letter — validation cluster |
...
|-------|----------------|
| Index class letter definitions | [`notebooks/data/sound_change_abbreviations.txt`](../../../notebooks/data/sound_change_abbreviations.txt); [HTML §5 Key to Abbreviations](file:///home/pappa/Projects/Pappa/conlanger/notebooks/data/index_diachronica_original.html#Abbreviations) |
