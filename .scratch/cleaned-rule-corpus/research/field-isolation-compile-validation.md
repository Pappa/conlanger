...
**Prefer a sidecar CSV** (e.g. `inventory/asca-field-isolation.csv`), joined by `(section_index, section_name, rule_idx)`, rather than widening the main inventory CSV for every rule.
