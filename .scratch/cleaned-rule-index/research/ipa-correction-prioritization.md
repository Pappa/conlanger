...
- Inventory regen: `uv run create_index && uv run validate_rules` → [`asca-rule-inventory-summary.md`](../inventory/asca-rule-inventory-summary.md)
...
- Auxiliary CSVs: [`expected_ipa_errors.csv`](../inventory/expected_ipa_errors.csv), [`invalid_ipa_errors.csv`](../inventory/invalid_ipa_errors.csv), [`expected_range_dots_errors.csv`](../inventory/expected_range_dots_errors.csv), [`asca-field-isolation-error.csv`](../inventory/asca-field-isolation-error.csv)
