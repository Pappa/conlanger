...
Blocked by: [69](69-correction-pass-flatten-nested-context-sets.md)
...
**Sequencing:** **`Blocked by: 69`** — shared helper and P4 wiring should land in #69 first; this ticket extends the same hook to `stages` only.
...
**Blocker cleared:** Spike [85](85-spike-nested-set-flatten-prototype.md) resolved. Pick up **after #69** (shared helper).
