...
**Leftover (not this ticket):** `input` / `output` / `env` / `exception` stay Index-raw; join is stored on `value` at construction, not performed in `__str__`. Field isolation still reads the raw attributes. Follow-on: [99](99-compiled-fields-join-at-render.md). [94](94-grill-structured-soundchangerule-ir.md) waits on 99.

## Comments

> *This was generated by AI during triage.*

**2026-08-29:** Marked `resolved`. `.rsca` emit matches the 93 contract. Compiled-field storage / join-at-render deferred to [99](99-compiled-fields-join-at-render.md).
