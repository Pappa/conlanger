...
Status corrected from `ready-for-agent` → `ready-for-human`: this is a **grilling** ticket ("Do not implement"). Blocker #44 resolved; prototype #46 resolved — ready for maintainer grill session to lock SoT spacing policy.