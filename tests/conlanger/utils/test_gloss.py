...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("xyz", True),
        ("= /ə/?", True),
        ("C:[-front,+back,+hi,-lo] = w ?", True),
        (" // C:[-front,+back,+hi,-lo] = w ?", True),
        ("{C,#}V[-long]", False),
        ("{C,#}Vː[+falling tone]", False),
        ("V[+high -ATR]", False),
        ("C,0", False),
        ("C…C", False),
        ("C...C", False),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("k(ʼ)", "k(ʼ)", []),
        (
            "t k (may have been part of a more sweeping merger",
            "t k",
            ["(may have been part of a more sweeping merger"],
        ),
        ("f (Common Celtic", "f", ["(Common Celtic"]),
        ("ej (əw)", "ej (əw)", []),
        ("e (= /ə/?) ∅", "e ∅", ["(= /ə/?)"]),
        ("_C(C) when stressed", "_C(C) when stressed", []),
        ("({C,#}V[-long])ʔ", "({C,#}V[-long])ʔ", []),
        ("({C,#}Vː[+falling tone])∅", "({C,#}Vː[+falling tone])∅", []),
        (
